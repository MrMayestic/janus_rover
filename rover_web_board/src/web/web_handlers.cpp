...
{
    String sendIt = "{\"temperature\":\"" + String(currentSensorData.m_currTemperature) + "\",\"humidity\":\"" + String(currentSensorData.m_currHumidity) + "\",\"voltage\":\"" + currentSensorData.m_currVoltage + "\"}";
